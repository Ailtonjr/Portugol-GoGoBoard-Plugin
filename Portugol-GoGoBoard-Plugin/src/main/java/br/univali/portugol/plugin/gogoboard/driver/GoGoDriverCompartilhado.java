 ...
 * a GoGo Board.
 *
 * É chamado de driver compartilhado, pois o dispositivo HID é aberto em cada
 * comunicação e já é fechado ao final da mesma, mantendo o dispositivo sempre
 * disponivel e evitando assim o bloqueio de uso por uma outra classe ou aba do
 * Portugol Studio.
 *
 * @author Ailton Cardoso Jr
 * @version 1.0
 */
public final class GoGoDriverCompartilhado extends GoGoDriver {

    /**
     * Construtor padrão do driver da GoGo Board.
     */
    public GoGoDriverCompartilhado() {
        try {
            iniciarServicosHID();
